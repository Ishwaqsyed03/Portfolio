...
export default function AdminLayout({ children }: AdminLayoutProps) {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-black to-purple-800">
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 min-h-screen bg-black/20 backdrop-blur-sm border-r border-purple-500/30">
          <div className="p-6">
            <h1 className="text-2xl font-bold text-white mb-8">Portfolio Admin</h1>
            <nav className="space-y-4">
              <a
                href="/admin/dashboard"
                className="flex items-center space-x-3 text-purple-300 hover:text-white hover:bg-purple-500/20 px-4 py-2 rounded-lg transition-all duration-200"
              >
          ...
          <div className="absolute bottom-0 left-0 right-0 w-64 p-6">
            <button
              ...
              className="w-full flex items-center space-x-3 text-red-400 hover:text-white hover:bg-red-500/20 px-4 py-2 rounded-lg transition-all duration-200"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
